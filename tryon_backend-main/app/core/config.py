...
class Settings(BaseSettings):
    ...
    GENERATION_MODAL_DISPATCH_WORKERS: int = 5
    # Local control-plane workers. These do NOT cap Modal GPU execution capacity.
    GENERATION_MODAL_QUEUE_DISPATCHERS: int = 16
    GENERATION_MODAL_FINALIZER_WORKERS: int = 16
    GENERATION_MODAL_FINALIZATION_RETRIES: int = 5
    GENERATION_MODAL_RECONCILE_SECONDS: int = 30
    GENERATION_MODAL_RECOVERY_BATCH_SIZE: int = 50
    GENERATION_MODAL_RECOVERY_BATCH_DELAY_MS: int = 250
