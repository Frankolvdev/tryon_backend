...
LABELS = {
    ...
    "modal_concurrency": ("Concurrencia por contenedor de Modal", "Entradas simultáneas por contenedor GPU."),
...
class AiEngineSettingsService:
    ...
    def update(self, db: Session, data: AiEngineSettingsUpdate) -> AiEngineSettingsResponse:
        incoming={
            ...
            "modal_concurrency":data.modal_concurrency,"modal_scaledown_window_seconds":data.modal_scaledown_window_seconds,
