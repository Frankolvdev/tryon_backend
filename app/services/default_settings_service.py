    ...
    def seed_defaults(self, db: Session) -> dict:
        defaults = [
            ...
            SystemSettingCreate(
                ...
                description="Controls generation loaders only: use the original provider-processing ETA or the UI-only Backend wall-clock ETA. Uploads, pricing and other loaders are unaffected.",
                value_type=SettingValueType.STRING,
                value="elapsed_estimate",
